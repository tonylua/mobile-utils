(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("mobile-utils", ["underscore"], factory);
	else if(typeof exports === 'object')
		exports["mobile-utils"] = factory(require("underscore"));
	else
		root["mobile-utils"] = factory(root["underscore"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (typeof window === 'undefined') {
	    ...
	    env = _underscore2.default.assign({}, _default, {
	        ua: _ua,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transformXY = function transformXY(dom) {
		let _vendor = /webkit/i.test(navigator.appVersion) ? "webkit" : /firefox/i.test(navigator.userAgent) ? "Moz" : "opera" in window ? "O" : /MSIE/i.test(navigator.userAgent) ? "ms" : "",
		    _has3d = "WebKitCSSMatrix" in window && "m11" in new WebKitCSSMatrix(),
		    _trnOpen = "translate" + (_has3d ? "3d(" : "("),
		    _trnClose = _has3d ? ",0)" : ")";
	    let x = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
	    let y = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
	    let duration = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getTime(setting) {
	    setting = _underscore2.default.assign({
	        offset: 0,
	        zeroTime: false,
	        clean: false,
	        from: new Date()
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ScrollLocker = exports.write_CSS = exports.page_to_top = exports.check_appcache = undefined;
	...
	var ScrollLocker = function () {
	    ...
	    function ScrollLocker(settings) {
	        ...
	        this._cfg = _underscore2.default.assign({
	            ignores: []
	        }, settings);
