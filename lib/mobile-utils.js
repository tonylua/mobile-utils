...
/***/ function(module, exports, __webpack_require__) {
	...
	exports._aDay = exports._aHour = exports._aMinute = exports._aSecond = exports._tz = exports._timezone = undefined;
	...
	exports.dates_of_month = dates_of_month;
	...
	var _timezone = exports._timezone = new Date().getTimezoneOffset(),
	    _tz = exports._tz = parseInt(_timezone / 60),
	
	// _testDateIOSTrans = (env.ios || /invalid/.test((new Date((new Date).toISOString())).toString().toLowerCase())),
	_aSecond = exports._aSecond = 1000,
	...
	function get_clean_date() {
	    ...
	    var d = getTime({ clean: true, zeroTime: false });
	    //TODO
	 ...
	 */
	function dates_of_month(p_year) {
	    var p_month = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
